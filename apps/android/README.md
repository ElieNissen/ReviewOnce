...
- la bibliothèque est lue dans une WebView Chromium invisible qui partage cette session, sans second client réseau ;
...
Letterboxd n’apparaît que pour la connexion ou si une vérification humaine est exceptionnellement demandée. Une barre ReviewOnce adaptée aux zones système permet toujours de revenir à l’application.
